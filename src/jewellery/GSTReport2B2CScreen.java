 ...
 * @author ASUS
 */
public class GSTReport2B2CScreen extends javax.swing.JFrame {

    private ImageIcon imageIcon;
    
    public GSTReport2B2CScreen() {
        initComponents();
   ...
   c.close();
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new DefaultTableModel(
        	...
        	new String[] {
        		"Name", "Invoice Date", "Invoice No.", "Value", "POS", "Invoice Type", "Rate", "Taxable Amt"
        	}
        ));
        ...
        jToggleButton1.setIcon(new ImageIcon(GSTReport2B2CScreen.class.getResource("/assets/icons8-ok-48.png"))); // NOI18N
        ...
        lblBbSaleInvoices.setText("B2C Purchase Invoice From Taxable Person");
        ...
        jPanel1Layout.setHorizontalGroup(
        	jPanel1Layout.createParallelGroup(Alignment.LEADING)
        		...
        		.addGroup(jPanel1Layout.createSequentialGroup()
        			.addContainerGap()
        			.addComponent(jScrollPane1, GroupLayout.DEFAULT_SIZE, 1276, Short.MAX_VALUE)
        			.addContainerGap())
        		.addGroup(jPanel1Layout.createSequentialGroup()
        			.addGap(28)
        			.addComponent(TotalBillAmt, GroupLayout.PREFERRED_SIZE, 125, GroupLayout.PREFERRED_SIZE)
        			.addGap(18)
        			.addComponent(txtBillAmt, GroupLayout.PREFERRED_SIZE, 169, GroupLayout.PREFERRED_SIZE)
        			.addGap(38)
        			.addComponent(TotalTaxableAmt, GroupLayout.PREFERRED_SIZE, 159, GroupLayout.PREFERRED_SIZE)
        			.addPreferredGap(ComponentPlacement.UNRELATED)
        			.addComponent(txtTaxableAmt, GroupLayout.PREFERRED_SIZE, 171, GroupLayout.PREFERRED_SIZE)
        			.addGap(18)
        			.addComponent(TotalTaxAmt, GroupLayout.PREFERRED_SIZE, 124, GroupLayout.PREFERRED_SIZE)
        			.addPreferredGap(ComponentPlacement.UNRELATED)
        			.addComponent(txtTaxAmt, GroupLayout.PREFERRED_SIZE, 176, GroupLayout.PREFERRED_SIZE)
        			.addGap(250))
        );
