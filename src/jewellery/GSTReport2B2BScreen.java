 ...
 * @author ASUS
 */
public class GSTReport2B2BScreen extends javax.swing.JFrame {

    private ImageIcon imageIcon;
    
    public GSTReport2B2BScreen() {
        initComponents();
   ...
   c.close();
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new DefaultTableModel(
        	...
        	new String[] {
        		"Name", "Invoice Date", "Invoice No.", "Value", "POS", "Invoice Type", "Rate", "Taxable Amt", "IGST", "SGST", "CGST"
        	}
        ));
        ...
        jToggleButton1.setIcon(new ImageIcon(GSTReport2B2BScreen.class.getResource("/assets/icons8-ok-48.png"))); // NOI18N
        ...
        lblBbSaleInvoices.setText("B2B Purchase Invoice From Taxable Person");
        ...
        JLabel TotalIGSTAmt = new JLabel("Total IGST Amt");
        TotalIGSTAmt.setFont(new Font("Tahoma", Font.PLAIN, 15));
        
        JLabel TotalCGSTAmt = new JLabel("Total CGST Amt");
        TotalCGSTAmt.setFont(new Font("Tahoma", Font.PLAIN, 15));
        
        JLabel TotalSGSTAmt = new JLabel("Total SGST Amt");
        TotalSGSTAmt.setFont(new Font("Tahoma", Font.PLAIN, 15));
        ...
        txtIGSTAmt = new JTextField();
        txtIGSTAmt.setFont(new Font("Tahoma", Font.PLAIN, 15));
        txtIGSTAmt.setColumns(10);
        
        txtCGSTAmt = new JTextField();
        txtCGSTAmt.setFont(new Font("Tahoma", Font.PLAIN, 15));
        txtCGSTAmt.setColumns(10);
        
        txtSGSTAmt = new JTextField();
        txtSGSTAmt.setFont(new Font("Tahoma", Font.PLAIN, 15));
        txtSGSTAmt.setColumns(10);
        
        txtTaxAmt = new JTextField();
        txtTaxAmt.setFont(new Font("Tahoma", Font.PLAIN, 15));
        txtTaxAmt.setColumns(10);
        
        JCheckBox chckbxNewCheckBox = new JCheckBox("Interstate");
        chckbxNewCheckBox.setFont(new Font("Tahoma", Font.BOLD, 12));
        
        JCheckBox chckbxNewCheckBox_1 = new JCheckBox("Local");
        	...
        	jPanel1Layout.createParallelGroup(Alignment.LEADING)
        		.addGroup(jPanel1Layout.createSequentialGroup()
        			...
        			.addGroup(jPanel1Layout.createParallelGroup(Alignment.LEADING)
        				...
        				.addGroup(jPanel1Layout.createSequentialGroup()
        					.addComponent(lblBbSaleInvoices, GroupLayout.PREFERRED_SIZE, 336, GroupLayout.PREFERRED_SIZE)
        			...
        			.addGroup(jPanel1Layout.createParallelGroup(Alignment.LEADING, false)
        				...
        				.addComponent(dateFrom, GroupLayout.DEFAULT_SIZE, 152, Short.MAX_VALUE))
        			.addGap(30)
        			.addComponent(jToggleButton1, GroupLayout.PREFERRED_SIZE, 61, GroupLayout.PREFERRED_SIZE)
        			.addGap(18)
        			.addGroup(jPanel1Layout.createParallelGroup(Alignment.LEADING)
        				.addComponent(chckbxNewCheckBox_1, GroupLayout.PREFERRED_SIZE, 80, GroupLayout.PREFERRED_SIZE)
        				.addComponent(chckbxNewCheckBox, GroupLayout.PREFERRED_SIZE, 99, GroupLayout.PREFERRED_SIZE))
        			.addGap(39)
        			.addComponent(btnPrint, GroupLayout.PREFERRED_SIZE, 90, GroupLayout.PREFERRED_SIZE)
        			.addGap(18)
        		...
        		.addGroup(jPanel1Layout.createSequentialGroup()
        			.addContainerGap()
        			.addComponent(jScrollPane1, GroupLayout.DEFAULT_SIZE, 1169, Short.MAX_VALUE)
        			.addContainerGap())
        		.addGroup(jPanel1Layout.createSequentialGroup()
        			.addGap(28)
        			.addGroup(jPanel1Layout.createParallelGroup(Alignment.LEADING)
        				.addGroup(jPanel1Layout.createSequentialGroup()
        					.addComponent(TotalBillAmt, GroupLayout.DEFAULT_SIZE, 133, Short.MAX_VALUE)
        					.addGap(30))
        				.addGroup(jPanel1Layout.createSequentialGroup()
        					.addComponent(txtBillAmt, GroupLayout.PREFERRED_SIZE, 122, GroupLayout.PREFERRED_SIZE)
        					.addPreferredGap(ComponentPlacement.RELATED)))
        			.addGroup(jPanel1Layout.createParallelGroup(Alignment.TRAILING)
        				.addComponent(txtTaxableAmt, Alignment.LEADING, GroupLayout.DEFAULT_SIZE, 133, Short.MAX_VALUE)
        				.addComponent(TotalTaxableAmt, GroupLayout.DEFAULT_SIZE, 133, Short.MAX_VALUE))
        			.addGap(34)
        			.addGroup(jPanel1Layout.createParallelGroup(Alignment.LEADING)
        				.addGroup(jPanel1Layout.createSequentialGroup()
        					.addComponent(TotalIGSTAmt, GroupLayout.DEFAULT_SIZE, 133, Short.MAX_VALUE)
        					.addGap(43))
        				.addGroup(jPanel1Layout.createSequentialGroup()
        					.addComponent(txtIGSTAmt, GroupLayout.PREFERRED_SIZE, 122, GroupLayout.PREFERRED_SIZE)
        					.addGap(38)))
        			.addGroup(jPanel1Layout.createParallelGroup(Alignment.LEADING)
        				.addGroup(jPanel1Layout.createSequentialGroup()
        					.addComponent(TotalCGSTAmt, GroupLayout.DEFAULT_SIZE, 133, Short.MAX_VALUE)
        					.addGap(44))
        				.addGroup(jPanel1Layout.createSequentialGroup()
        					.addComponent(txtCGSTAmt, GroupLayout.PREFERRED_SIZE, 122, GroupLayout.PREFERRED_SIZE)
        					.addGap(39)))
        			.addGroup(jPanel1Layout.createParallelGroup(Alignment.LEADING)
        				.addGroup(jPanel1Layout.createSequentialGroup()
        					.addComponent(TotalSGSTAmt, GroupLayout.DEFAULT_SIZE, 133, Short.MAX_VALUE)
        					.addGap(39))
        				.addGroup(jPanel1Layout.createSequentialGroup()
        					.addComponent(txtSGSTAmt, GroupLayout.PREFERRED_SIZE, 122, GroupLayout.PREFERRED_SIZE)
        					.addGap(34)))
        			.addGroup(jPanel1Layout.createParallelGroup(Alignment.LEADING)
        				.addGroup(jPanel1Layout.createSequentialGroup()
        					.addComponent(TotalTaxAmt, GroupLayout.DEFAULT_SIZE, 137, Short.MAX_VALUE)
        					.addGap(169))
        				.addGroup(jPanel1Layout.createSequentialGroup()
        					.addComponent(txtTaxAmt, GroupLayout.PREFERRED_SIZE, 122, GroupLayout.PREFERRED_SIZE)
        					.addGap(164))))
        );
        		...
        		.addGroup(jPanel1Layout.createSequentialGroup()
        			...
        			.addGroup(jPanel1Layout.createParallelGroup(Alignment.TRAILING)
        				...
        				.addGroup(jPanel1Layout.createParallelGroup(Alignment.TRAILING, false)
        					...
        					.addComponent(jToggleButton1, GroupLayout.PREFERRED_SIZE, 53, GroupLayout.PREFERRED_SIZE)))
        			.addGap(18)
        			...
        			.addGroup(jPanel1Layout.createParallelGroup(Alignment.LEADING)
        				...
        				.addGroup(jPanel1Layout.createParallelGroup(Alignment.BASELINE)
        					...
        					.addComponent(TotalSGSTAmt, GroupLayout.PREFERRED_SIZE, 22, GroupLayout.PREFERRED_SIZE)
        					.addComponent(TotalCGSTAmt, GroupLayout.PREFERRED_SIZE, 22, GroupLayout.PREFERRED_SIZE)
        					.addComponent(TotalIGSTAmt, GroupLayout.PREFERRED_SIZE, 22, GroupLayout.PREFERRED_SIZE)))
        			.addPreferredGap(ComponentPlacement.UNRELATED)
        			.addGroup(jPanel1Layout.createParallelGroup(Alignment.LEADING)
        				...
        				.addComponent(txtIGSTAmt, GroupLayout.PREFERRED_SIZE, 30, GroupLayout.PREFERRED_SIZE)
        				.addComponent(txtCGSTAmt, GroupLayout.PREFERRED_SIZE, 30, GroupLayout.PREFERRED_SIZE)
        				.addComponent(txtSGSTAmt, GroupLayout.PREFERRED_SIZE, 30, GroupLayout.PREFERRED_SIZE)
...
public void filter3(Date startDate, Date endDate){
   ...
   jTable1.setRowSorter(tr);
    ...
    private JTextField txtIGSTAmt;
    private JTextField txtCGSTAmt;
    private JTextField txtSGSTAmt;
