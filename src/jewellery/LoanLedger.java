    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {
        try {
            ...
            if (loanLedgerEntries == null) {
                ...
                JOptionPane.showMessageDialog(this, "Error fetching loan ledger entries",
            ...
            for (List<Object> row : loanLedgerEntries) {
                ...
                loanBalance = loanBal; // Use the latest balance from the database
            ...
            Logger.getLogger(this.getClass().getName()).log(Level.SEVERE, "Error in jButton1ActionPerformed", ex);
