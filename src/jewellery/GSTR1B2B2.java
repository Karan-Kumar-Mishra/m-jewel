 ...
 * @author Dhawal
 */
public class GSTR1B2B2 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addComponent(btnOk, javax.swing.GroupLayout.DEFAULT_SIZE, 85, Short.MAX_VALUE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
        ...
        tblGSTHistoryData.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                 "Date", "Bill No.", "Party", "Item", "Qty", "Gross Wt.", "Price", "IGST", "CGST", "SGST", "Net Amt."
            }
        ) {
...
//                .addContainerGap(39, Short.MAX_VALUE))
  ...
  public void populateSalesListTable(String fromDate, String toDate) {
        ...
        selectedDatesData = DBController.getDataFromTable("SELECT bill, date, partyname, itemname, "
                + "qty, grosswt, price, net_amount"
                + " FROM "
        ...
        selectedDatesData.forEach((List<Object> item) -> {
            ...
            String  billNo = (String) item.get(0);
            Date date = (Date) item.get(1);
            String partyname = (String) item.get(2);
            String itemname = (String) item.get(3);
            Integer qty = Integer.valueOf( item.get(4).toString());
            Double grosswt = Double.valueOf( item.get(5).toString());
            Long price = Long.valueOf( item.get(6).toString());             
            Double netamount = Double.valueOf( item.get(7).toString());   
...
//            totalTaxAmountValue += gst_amt;
            ...
            salesListTableModel.addRow(new Object[]{
                date, billNo, partyname, itemname, qty, grosswt, price,"","","", netamount
...
public void populateSalesListTable() {
     ...
     salesListTableModel.setRowCount(0);
        ...
        selectedDatesData.forEach((List<Object> item) -> {
            ...
            String partyname = (String) item.get(2);
            String itemname = (String) item.get(3);
            Integer qty = (Integer) item.get(4);
            Double grosswt = (Double) item.get(5);
            Long price = (Long) item.get(6);             // can be null
            Long netamount = (Long) item.get(7);    
...
//        totalTaxAmount.setText(String.valueOf(df.format(totalTaxAmountValue)));
    ...
    private void tblGSTHistoryDataMouseClicked(java.awt.event.MouseEvent evt) {                                               
        // TODO add your handling code here:
    ...
    private void totalBillAmountActionPerformed(java.awt.event.ActionEvent evt) {                                                
        // TODO add your handling code here:
    }                                               

    private void totalTaxableAmountActionPerformed(java.awt.event.ActionEvent evt) {                                                   
        // TODO add your handling code here:
    }                                                  

    private void totalTaxAmountActionPerformed(java.awt.event.ActionEvent evt) {                                               
        // TODO add your handling code here:
    }                                              
