...
public class GetLoanDataByPartyName {
    public static String[][] getinfo(String KeyPartyName) {
        ...
        try {
            ...
            String sql = "SELECT SLIP_NO, PARTY_NAME, AMOUNT_PAID, INTEREST_DATE_PERCENTAGE, REMARKS,START_DATE  FROM LOAN_ENTRY WHERE PARTY_NAME="+KeyPartyName;
