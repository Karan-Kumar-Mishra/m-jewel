 ...
 *
 * @author AR-LABS
 * For: Java Developer Internship
 * 
 * If you look at the code, you will feel like it's written
 * by a NOOB who was learning java when he wrote this code but 
 * believe me it is not how i wanted to write this code. Unfortunately,
 * due to time limitations, I was not able to write the best version of this.
 * I even thought of refactoring this code but realized that I was running out
 * of time and that I had other very important things to do. so please pardon
 * this NOOBINESS.
 *                  - A depressed fellow programmer
 */
